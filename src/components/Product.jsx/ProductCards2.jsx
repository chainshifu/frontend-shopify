...
function ProductCards2({ data, handleOrderPopup }) {
  return (
    <div className="mb-10">
        ...
        {data.map((item) => (
          <div key={item.id} className="group">
            <div className="bg-gradient-to-r from-gray-400 to-gray-400 rounded-md relative">
              ...
              />
              <div
                className="hidden group-hover:flex absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-full h-full justify-center items-center text-center group-hover:backdrop-blur-[1.5px] duration-200"
